...
//go:generate swagger generate server --target ../../server --name DiabloBuilderAPI --spec ../../swagger.yml --principal interface{} --exclude-main

func configureFlags(api *operations.DiabloBuilderAPIAPI) {
	// api.CommandLineOptionsGroups = []swag.CommandLineOptionsGroup{ ... }
}

func configureAPI(api *operations.DiabloBuilderAPIAPI) http.Handler {
